...
아이 키우는 부모가 "내 훈육 방식이 맞나?" 싶을 때, 자기 상황을 털어놓고 상담받는 챗봇 웹사이트.
**두 전문가의 영상 내용만을 근거**로 답합니다.

- **최민준 소장**(아들연구소) — 아들 기질·훈육·대화·행동 육아
  (지식인초대석 풀버전 `자식이 의외로 평생 기억하고 고마워하는 부모의 한 마디`)
- **조선미 교수**(아주대 정신건강의학과) — 학습·정체성·또래관계·스마트폰·부모 권위·독립
  (지식인초대석 EP.103 1부 · EP.104 2부)
- 각 영상 전사 → 핵심 원칙 정리(`knowledge.md`) → Claude가 그 자료 안에서만, 누구 관점인지
  밝히며 조언
