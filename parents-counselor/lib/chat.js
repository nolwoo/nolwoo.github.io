...
- 체벌·위협 정당화 요청 → 부드럽게 거부하고 대안 제시${knowledgePart}`;
  }
...
# 안전장치
- 아동학대·심각한 폭력 신호 → 즉각 안내: 112 / 아동보호 1577-1391${knowledgePart}`;
  }
...
- 체벌 정당화 요청 → 부드럽게 대안 제시${knowledgePart}`;
}

const GREETINGS = {
  urgent: '지금 상황을 말씀해 주세요. 음성으로 설명하셔도 되고, 텍스트 탭으로 입력하셔도 됩니다. 최대한 빠르게 도와드릴게요.',
